({
    ...
    isTypeOf: function(obj, name){ return toString.call(obj) === '[object ' + name + ']'; }, 
    ...
    partial: function(func) {
        ...
        return this.callback(function() { 
            var pos = 0, args = this.map(rest, (arg) => { return arg === this ? arguments[pos++] : arg; });
            while(pos < arguments.length) { args.push(arguments[pos++]); }
    ...
    promise: function(callback, context){
        return new Promise(this.callback(callback, context));
    },
    deferred: function(){
        var defer = {};
